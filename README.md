...
### Standalone Voice/Gesture Tracker (M-Series Optimized)

We built a bleeding-edge standalone Python application (`live_isl.py`) that runs natively on macOS without a browser, using OpenCV and MediaPipe Tasks.

Features include:
- **Live Vector Tracking**: Real-time 3D hand tracking and localized gesture estimation math.
- **Micro-expression Tracking**: Natively parses 52 facial blendshapes to report moods (Happy, Sad, Excited, Confused, Neutral).
- **macOS TTS**: Instantly translates verified gestures into an audible English voice via the macOS `say` command.
...
python live_isl.py
```
*(Press `S` to speak your built sentence, `C` to clear, `Q` to quit).*
...
model = slt.models.ConcatenativeSynthesis(
   text_language="english", sign_language="in-sl", sign_format="video" )

text = "this is very good" # "this-very-good-is"
...
| - | - | - | :-: |
| [Indian Sign Language](https://github.com/sign-language-translator/sign-language-translator/blob/main/sign_language_translator/languages/sign/indian_sign_language.py) | 50 (Custom) | - | [details](https://github.com/sign-language-translator/sign-language-datasets#datasets) |
...
└── <b style="font-size:large;">sign_language_translator</b>
    ...
    │   ├── sign
    │   │   ├── <a href="https://github.com/sign-language-translator/sign-language-translator/blob/main/sign_language_translator/languages/sign/indian_sign_language.py">indian_sign_language.py</a>
