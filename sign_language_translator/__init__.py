...
.. code-block:: python
    ...
    model.text_language = slt.TextLanguageCodes.ENGLISH     # slt.languages.text.English()
    model.sign_format = slt.SignFormatCodes.LANDMARKS
    model.sign_embedding_model = "mediapipe-world"

    sign_2 = model.translate("how are you")
    ...
    # sign = slt.Video.load_asset("in-myorg-1_hello")
