...
def translate(
    ...
    Examples:\n
        $ slt translate --model-code rule-based --text-lang english --sign-lang isl --sign-format video "this is good."
    """
...
def complete(
    ...
    1. english-mixed-ngram (token | start: "<")\n
    2. en-supported-gpt (token | start: "<")\n
    3. unigram-names (char | start: "[")\n
    4. bigram-names  (char | start: "[a")\n
    5. trigram-names (char | start: "[ab")\n
    Examples:\n
        $ slt complete "<" --model-code english-mixed-ngram -w 1.0 --model-code en-supported-gpt -w 1.5
    """
