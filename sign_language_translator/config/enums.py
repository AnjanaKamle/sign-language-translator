...
class Countries(Enum, metaclass=PrintableEnumMeta):
    ...
    Attributes:
        - INDIA (str): Short code for India.
        ...
    """
...
class Organizations(Enum, metaclass=PrintableEnumMeta):
    ...
    Attributes:
        - MYORG (str): Short code for custom video organization.
        ...
    """

    MYORG = "myorg"
    """Custom organization for Indian Sign Language videos"""
...
class SignCollections(Enum, metaclass=PrintableEnumMeta):
    ...
    Attributes:
        - IN_MYORG_1 (str): Short code for the first sign dictionary from Custom Organization, India.
        ...
    """

    IN_MYORG_1 = f"{Countries.INDIA}-{Organizations.MYORG}-1"
    """Short code for the first sign dictionary of Indian Sign Language custom videos."""
...
class SignLanguages(Enum, metaclass=PrintableEnumMeta):
    ...
    Attributes:
        - INDIAN_SIGN_LANGUAGE (str): Short code for the Indian Sign Language.
        ...
    """
...
class ModelCodeGroups(Enum, metaclass=PrintableEnumMeta):
    ...
    ALL_TRANSFORMER_LANGUAGE_MODELS = set()
    ALL_MIXER_LANGUAGE_MODELS = set()
    ALL_LANGUAGE_MODELS = (
        ALL_NGRAM_LANGUAGE_MODELS
    ...
    ALL_MEDIAPIPE_EMBEDDING_MODELS = set()
    ALL_VIDEO_EMBEDDING_MODELS = ALL_MEDIAPIPE_EMBEDDING_MODELS

    # text embedding models
    ALL_VECTOR_LOOKUP_MODELS = set()
...
def normalize_short_code(short_code: Union[str, Enum]) -> str:
    ...
    normalized_to_codes = {
        ...
        SignLanguages.INDIAN_SIGN_LANGUAGE.value: {
            "isl",
            "in-sl",
